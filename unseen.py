...
path = r"C:\Users\Acer\PycharmProjects\unseen\register\login.txt"

summary1 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary1.txt"
summary2 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary2.txt"
summary3 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary3.txt"
summary4 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary4.txt"
summary5 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary5.txt"
summary6 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary6.txt"
summary7 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary7.txt"
summary8 = r"CC:\Users\Acer\PycharmProjects\unseen\summary\summary8.txt"
summary9 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary9.txt"
summary10 = r"C:\Users\Acer\PycharmProjects\unseen\summary\summary10.txt"
...
class homepage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        img1 = ImageTk.PhotoImage(file="images/panther.png")
        img2 = ImageTk.PhotoImage(file="images/rim.jpeg")
        img3 = ImageTk.PhotoImage(file="images/titu.jpg")
        img4 = ImageTk.PhotoImage(file="images/padmaavat.jpg")
        img5 = ImageTk.PhotoImage(file="images/paddington.jpg")
        img6 = ImageTk.PhotoImage(file="images/manus.jpg")
        img7 = ImageTk.PhotoImage(file="images/star.jpg")
        img8 = ImageTk.PhotoImage(file="images/water.jpg")
        img9 = ImageTk.PhotoImage(file="images/raid.jpg")
        img10 = ImageTk.PhotoImage(file="images/padman.jpeg")



        butts = tk.Button(self, font=('italic', '9', 'bold'), fg="white", bg="white", height=8,
                          width=w2, bd=0, activebackground="white")
        logo_a = ImageTk.PhotoImage(file="images/newlogo.png")
        logo_b = ImageTk.PhotoImage(file="images/newlogo.png")
...
class page_one(tk.Frame):
    ...
    def Synopsis(self):
        if (movie_no == 1):
            ...
            self.poster1 = ImageTk.PhotoImage(file="images/mp1.jpg")
        ...
        if (movie_no == 2):
            ...
            self.poster2 = ImageTk.PhotoImage(file="images/mp2.jpg")
        ...
        if (movie_no == 3):
            ...
            self.poster3 = ImageTk.PhotoImage(file="images/mp3.jpg")
        ...
        if (movie_no == 4):
            ...
            self.poster4 = ImageTk.PhotoImage(file="images/mp4.jpg")
        ...
        if (movie_no == 5):
            ...
            self.poster5 = ImageTk.PhotoImage(file="images/mp5.jpg")
        ...
        if (movie_no == 6):
            ...
            self.poster6 = ImageTk.PhotoImage(file="images/mp6.jpg")
        ...
        if (movie_no == 7):
            ...
            self.poster7 = ImageTk.PhotoImage(file="images/mp7.jpg")
        ...
        if (movie_no == 8):
            ...
            self.poster8 = ImageTk.PhotoImage(file="images/mp8.jpg")
        ...
        if (movie_no == 9):
            ...
            self.poster9 = ImageTk.PhotoImage(file="images/mp9.jpg")
        ...
        if (movie_no == 10):
            ...
            self.poster10 = ImageTk.PhotoImage(file="images/mp10.jpg")
...
class register(tk.Frame):
    def __init__(self, parent, controller):
        ...
        background_image = ImageTk.PhotoImage(file="images/darth.jpg")
